...
<div class="page-title grey">
   <div class="container">
      <div class="title-area pull-left">
         <h2>Petcare <small>Best pet care, cage and eat</small></h2>
         <div class="bread">
            <ol class="breadcrumb">
               <li><a href="#">Home</a></li>
            ...
            <div class="row">
               <div class="col-md-5 col-sm-5 col-xs-12">
                  <div class="product-images">
                     <a data-rel="prettyPhoto" href="{{ URL::asset('petvet/upload/canila.jpg') }}" title="">
                     <img class="img-polaroid" src="{{ URL::asset('petvet/upload/canila.jpg') }}" alt=""/>
                     </a>
               ...
               <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="shop-desc">
                     <h3>Vanilla Petcare</h3>
                     <small>Perumahan Wisma Lidah Kulon A No.89, Lidah Kulon, Lakarsantri, Surabaya</small>
                     <div class="rating">
                     ...
                     <p>Vanillapetcare menyediakan layanan kesehatan bagi hewan peliharaan anda. Kami melayani hewan kesayangan anda dengan sepenuh hati. Berikut layanana : Konsultasi Kesehatan, grooming sehat, vaksinasi Anjing & Kucing, scalling gigi, minor surgery, penitipan hewan sehat, perawatan dermatologi hewan. Mari Sejahterakan "Mereka", Kontak WA/SMS : 082232394967. Vanillapetcare "We Take Care of Your Pet""</p>
                     ...
                     <div class="tabbed-widget">
                        ...
                        <div class="tab-content">
                           <div id="home" class="tab-pane fade in active">
                              <div class="row">
                                 <p><img src="{{ URL::asset('petvet/images/dog-cage.jpg') }}" class="alignleft" alt=""> Cat Cage
                                    <br><strong><small>Rp.25000/Day </small></strong>
                                    <br>
                                    <a href="{{ url('/petcare-checkout/1') }}" class="btn btn-primary" style="float:right;">Checkout</a>
                                 </p>
                                 <br><br>
                              </div>
                              <div class="row">
                                 <p><img src="{{ URL::asset('petvet/images/cat-cage.jpg') }}" class="alignleft" alt=""> Small Dog Cage
                                    <br><strong><small>Rp. 50000/Day</small></strong>
                                    <br>
                                    <a href="{{ url('/petcare-checkout/2') }}" class="btn btn-primary" style="float:right;">Checkout</a>
                                    <br><br>
                                 </p>
                              </div>
                           </div>
