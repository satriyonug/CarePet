               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                           <label>Address *</label>
                           <input type="text" name="name" id="name3" class="form-control" placeholder="Address">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-6">
                     <div class="widget-title">
	              	...
	              	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                    ...
	                    <input type="text" name="pet" id="kindofpet" class="form-control" placeholder="Kind of Pet">
	                </div>
	              	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                    <label>Duration</label>
	                    <input type="text" name="pet" id="duration" class="form-control" placeholder="Duration">
	                </div>
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
