...
<a data-rel="prettyPhoto" href="{{ URL::asset('petvet/upload/shop_02.jpg') }}" title="">
<img class="img-polaroid" src="{{ URL::asset('petvet/upload/xshop_02.jpg.pagespeed.ic.c2WuvOxE4K.jpg') }}" alt=""/>
</a>
<ul class="thumbnail">
<li> <a data-rel="prettyPhoto[gallery]" href="{{ URL::asset('petvet/upload/shop_03.jpg') }}" title=""><img class="img-thumbnail" src="{{ URL::asset('petvet/upload/xshop_01.jpg.pagespeed.ic.tEfrtxhhVo.jpg') }}" alt=""/></a></li>
<li> <a data-rel="prettyPhoto[gallery]" href="{{ URL::asset('petvet/upload/shop_04.jpg') }}" title=""><img class="img-thumbnail" src="{{ URL::asset('petvet/upload/xshop_03.jpg.pagespeed.ic.IONcGIjklL.jpg') }}" alt=""/></a></li>
<li> <a data-rel="prettyPhoto[gallery]" href="{{ URL::asset('petvet/upload/shop_01.jpg') }}" title=""><img class="img-thumbnail" src="{{ URL::asset('petvet/upload/xshop_04.jpg.pagespeed.ic.SDayx1DpGB.jpg') }}" alt=""/></a></li>
</ul>
</div>
</div>
...
<a href="{{ url('/shop-checkout') }}" class="btn btn-primary">Add to Cart</a>
<div class="addwish">
